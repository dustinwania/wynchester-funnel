            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="text-sm text-gray-200">
                  ...
                  <p className="mb-4">Email: info@wynchester.com</p>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  {/* Facebook */}
                  <Link href="https://www.facebook.com/carloanWLC" target="_blank" className="text-white hover:text-gray-200 transition-colors">
                  ...
                  {/* Instagram */}
                  <Link href="https://www.instagram.com/wlccarloans" target="_blank" className="text-white hover:text-gray-200 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
